...
/* prize added by lifenfen, power off after initialization ,resolve current leakage in factory test mode, 20190523 begin */
	sf_ctl_dev.power_on(false);
/* prize added by lifenfen, power off after initialization ,resolve current leakage in factory test mode, 20190523 end */
        sf_ctl_dev.free_gpio(&sf_ctl_dev);
        sf_platform_exit(&sf_ctl_dev);
        sf_ctl_dev.pdev = NULL;
        return err;
