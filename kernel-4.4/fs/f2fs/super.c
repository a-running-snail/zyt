...
{
  /*prize add by liuwei,data space limit, 2018-08-30 begin */
  //block_t limit = (sbi->user_block_count << 1) / 1000;
	block_t limit = (sbi->user_block_count << 1) / 166;
	/*prize add by liuwei,data space limit, 2018-08-30 end */
...
static void f2fs_tuning_parameters(struct f2fs_sb_info *sbi)
{
	...
	if (sm_i->main_segments <= SMALL_VOLUME_SEGMENTS) {
		...
		sm_i->dcc_info->discard_granularity = DEFAULT_DISCARD_GRANULARITY;
