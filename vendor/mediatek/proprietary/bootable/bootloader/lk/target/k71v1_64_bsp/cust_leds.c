...
/* prize modified by lifenfen, modified for customized backlight, 20190415 begin */
/*
enum led_brightness backlight_default_level = LED_FULL;
*/
enum led_brightness backlight_default_level = LED_HALF;//127
/* prize modified by lifenfen, modified for customized backlight, 20190415 end */
