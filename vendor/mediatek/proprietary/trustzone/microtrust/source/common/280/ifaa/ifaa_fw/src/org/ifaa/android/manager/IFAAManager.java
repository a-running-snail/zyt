...
public abstract class IFAAManager {
	...
	{
                IIFAAManagerService ifaa = IIFAAManagerService.Stub.asInterface(ServiceManager.getService("ifaa_service"));
                try {
                    return ifaa.processCmd(param);
                } catch (Exception e) {
                    Log.e(TAG, "FAILED to call ifaa_service");
                    e.printStackTrace();
               }
               return null;
	}
