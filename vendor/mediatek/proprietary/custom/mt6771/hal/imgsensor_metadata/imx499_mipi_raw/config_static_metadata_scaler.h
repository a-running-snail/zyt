...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_END()
    //==========================================================================
    /*prize  add  for insert  resolution by zhuzhengjiang    20190222-begin*/
#ifdef PRIZE_CAMERA_INSERT_SUPPORT
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_INSERT_STREAM_CONFIGURATIONS)//new hidden
                //prize  modify by zhuzhengjiang  for superzoom 20190110-begin
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32) //88mp 4:3
                CONFIG_ENTRY_VALUE(10816, MINT32)
                CONFIG_ENTRY_VALUE(8112, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
                //prize  modify by zhuzhengjiang  for superzoom 20190110-end
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32) //19mp 16:9
                CONFIG_ENTRY_VALUE(4608, MINT32)
                CONFIG_ENTRY_VALUE(2592, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

				//add previewsize and picturesize for 19.5:9-xiaoping-20190508-start
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32) //10mp 19.5:9
                CONFIG_ENTRY_VALUE(4608, MINT32)
                CONFIG_ENTRY_VALUE(2128, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
				//add previewsize and picturesize for 19.5:9-xiaoping-20190508-end				
				...
				//add previewsize and picturesize for 19.5:9-xiaoping-20190508-start
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32)
                CONFIG_ENTRY_VALUE(2352, MINT32)
				...
				//add previewsize and picturesize for 19.5:9-xiaoping-20190508-start
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32)
                CONFIG_ENTRY_VALUE(1552, MINT32)
    ...
    CONFIG_METADATA_END()
 #endif
    /*prize  add  for insert  resolution by zhuzhengjiang    20190222-end*/
    //==========================================================================
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_MIN_FRAME_DURATIONS)//new hidden
				...
				//add previewsize and picturesize for 19.5:9-xiaoping-20190508-start
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT64)
                CONFIG_ENTRY_VALUE(2352, MINT64)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT64)
                CONFIG_ENTRY_VALUE(1552, MINT64)
