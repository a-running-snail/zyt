...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_LENS_FOCAL_LENGTH)//not null
        CONFIG_ENTRY_VALUE(3.52f, MFLOAT) ///*prize  modify by zhuzhengjiang for FOCAL_LENGTH 20190305-begin*/
    CONFIG_METADATA_END()
    //==========================================================================//none
...
//------------------------------------------------------------------------------
    ...
    case CAMERA3_TEMPLATE_ZERO_SHUTTER_LAG:
        ...
        CONFIG_METADATA_END()
        CONFIG_METADATA_BEGIN(MTK_EDGE_MODE)//not null
             CONFIG_ENTRY_VALUE(MTK_EDGE_MODE_HIGH_QUALITY, MUINT8) // /*zhengjiang.zhu@prize.Camera.Driver  2018/12/18  add for cts testReprocessingCharacteristics*/
        CONFIG_METADATA_END()
        CONFIG_METADATA_BEGIN(MTK_EDGE_STRENGTH)
            CONFIG_ENTRY_VALUE(5, MUINT8)
        CONFIG_METADATA_END()
        ...
        CONFIG_METADATA_END()
        CONFIG_METADATA_BEGIN(MTK_NOISE_REDUCTION_MODE)//not null
            CONFIG_ENTRY_VALUE(MTK_NOISE_REDUCTION_MODE_HIGH_QUALITY, MUINT8) // /*zhengjiang.zhu@prize.Camera.Driver  2018/12/18  add for cts testReprocessingCharacteristics*/
        CONFIG_METADATA_END()
        CONFIG_METADATA_BEGIN(MTK_NOISE_REDUCTION_STRENGTH)
            CONFIG_ENTRY_VALUE(5, MUINT8)
        CONFIG_METADATA_END()
