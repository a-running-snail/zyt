...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_MAX_NUM_INPUT_STREAMS)//new hidden
        CONFIG_ENTRY_VALUE(0, MINT32) // 1 /*zhengjiang.zhu@prize.Camera.Driver  2018/12/18  add for cts testBasicOpaqueToJpegReprocessing*/
    CONFIG_METADATA_END()
    //==========================================================================
    ...
    CONFIG_METADATA_END()
    //==========================================================================
    /*zhengjiang.zhu@prize.Camera.Driver  2018/12/18  add for cts testBasicOpaqueToJpegReprocessing*/
    ...
    //==========================================================================
     CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_SESSION_KEYS)
        ...
        CONFIG_ENTRY_VALUE(MTK_BGSERVICE_FEATURE_PRERELEASE, MINT32)
        CONFIG_ENTRY_VALUE(MTK_BGSERVICE_FEATURE_IMAGEREADERID, MINT32)
        CONFIG_ENTRY_VALUE(MTK_HDR_FEATURE_SESSION_PARAM_HDR_MODE, MINT32)
        CONFIG_ENTRY_VALUE(MTK_CONFIGURE_SETTING_INIT_REQUEST, MINT32)
        //postview
        CONFIG_ENTRY_VALUE(MTK_CONTROL_CAPTURE_POSTVIEW_SIZE, MINT32)
