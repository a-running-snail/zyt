...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_SENSOR_INFO_PHYSICAL_SIZE) // mm
        CONFIG_ENTRY_VALUE(4.73f, MFLOAT) // 4.71 /*prize-camera  add for FOV by zhuzhengjiang 20190109*/  Resolutiom*pixel_size(4224*1.12=4730)
        CONFIG_ENTRY_VALUE(3.58f, MFLOAT) // 3.49 /*prize-camera  add for FOV by zhuzhengjiang 20190109*/  Resolutiom*pixel_size(3200*1.12=4730)
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_SENSOR_INFO_PIXEL_ARRAY_SIZE)
        CONFIG_ENTRY_VALUE(MSize(4160, 3120), MSize)
    CONFIG_METADATA_END()
    //==========================================================================
    ...
    CONFIG_METADATA_END()
    //==========================================================================
	//prize fengshangdong modify at 20190328
