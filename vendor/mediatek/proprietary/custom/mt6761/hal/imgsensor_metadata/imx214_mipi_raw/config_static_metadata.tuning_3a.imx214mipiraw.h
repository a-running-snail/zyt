...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_CONTROL_AE_AVAILABLE_TARGET_FPS_RANGES)
        ...
        //Cam 0: Target FPS range of (x, 20) where x <= 15 must be supported
        CONFIG_ENTRY_VALUE(15, MINT32)
        CONFIG_ENTRY_VALUE(20, MINT32)
        //prize-camera  add for Insertion resolution by zhuzhengjiang 20190105-end
        CONFIG_ENTRY_VALUE(20, MINT32)
        CONFIG_ENTRY_VALUE(20, MINT32)
...
//------------------------------------------------------------------------------
    ...
    //Doesn't support reprocessing but EDGE_MODE_ZERO_SHUTTER_LAG is supported
    ...
    CONFIG_METADATA_END()
    /*zhengjiang.zhu@prize.Camera.Driver  2018/12/18  end for cts testReprocessingCharacteristics*/
    //==========================================================================
//------------------------------------------------------------------------------
//  android.hotPixel
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
    //==========================================================================
    /*zhengjiang.zhu@prize.Camera.Driver  2018/12/18  add for cts testReprocessingCharacteristics*/
    //Doesn't support reprocessing but REDUCTION_MODE_ZERO_SHUTTER_LAG is supported
