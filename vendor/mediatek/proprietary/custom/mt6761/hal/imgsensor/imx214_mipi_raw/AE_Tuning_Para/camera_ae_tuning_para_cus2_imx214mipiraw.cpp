...
template <>
AE_NVRAM_T const&
getAENVRAM_imx214mipiraw<CAM_SCENARIO_CUSTOM2>() // AUTO HDR
{
    // rDevicesInfo
    ...
    static AE_CCT_CFG_T  g_rCCTConfig =
    {
        ...
        // rMeteringSpec
        {
            ...
            //rABL_Spec
            {
                ...
                220, //256, // final target limitation, 256/128 = 2x
                //sFgBgEVRatio
                {
                    2200,//2200, //i4X1
                    0,    //i4Y1
            ...
            // rTOUCHFD_Spec
            {
                ...
                45, //uFaceYLowBound;// 65 
                55, //uFaceYHighBound;// 75
