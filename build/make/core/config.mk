...
#prize-add prune prize_project-lanwm-20180824-begin
#prize-gms-luoyanzi-20170920-begin
#GMSDIR := 
#if gms dir exit
#ifeq (gms, $(wildcard gms))
#GMSDIR += $(strip $(shell ls gms))
#endif
#ifeq (,$(findstring $(PRIZE_CURRENT_GMS),$(GMSDIR)))
#    ifeq ($(strip $(BUILD_GMS)), yes)
#        $(error there is an error,PRIZE_CURRENT_GMS is not available!)
#    endif
#endif
#EXCLUDE_GMSDIR := $(filter-out $(PRIZE_CURRENT_GMS), $(GMSDIR))
#FIND_LEAVES_EXCLUDES := $(addprefix --prune=, $(SCAN_EXCLUDE_DIRS) $(EXCLUDE_GMSDIR) .repo .git prize_project )
FIND_LEAVES_EXCLUDES := $(addprefix --prune=, $(SCAN_EXCLUDE_DIRS) .repo .git prize_project )
#prize-gms-luoyanzi-20170920-end
#prize-add prune prize_project-lanwm-20180824-end
