...
#PRODUCT_COPY_FILES += $(LOCAL_PATH)/MT6771_Android_scatter.txt:MT6771_Android_scatter.txt
...
# prize modified by lifenfen, for barometer cts test, 20190307 begin
# ifneq ($(strip $(CUSTOM_KERNEL_BAROMETER)),)
ifeq ($(strip $(CUSTOM_KERNEL_BAROMETER)),yes)
# prize modified by lifenfen, for barometer cts test, 20190307 end
...
#prize-added by YZHD,lcd density,20190125,begin
ifneq ($(strip $(PRIZE_LCD_DENSITY)),)
PRODUCT_PROPERTY_OVERRIDES += ro.sf.lcd_density=$(strip $(PRIZE_LCD_DENSITY))
else
PRODUCT_PROPERTY_OVERRIDES += ro.sf.lcd_density=480
endif
#prize-added by YZHD,lcd density,20190125,end
...
# USB OTG
#prize-cts USB OTG support YZHD 20181226-begin
ifeq ($(strip $(PRIZE_OTG_TEST)),yes)
PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.usb.host.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.usb.host.xml
endif
#prize-cts USB OTG support YZHD 20181226-end
...
PRODUCT_PROPERTY_OVERRIDES += ro.mediatek.platform=MT6771
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k71v1_64_bsp/factory/res/sound/testpattern1.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/testpattern1.wav:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k71v1_64_bsp/factory/res/sound/ringtone.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/ringtone.wav:mtk

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6771/ACCDET.kl:system/usr/keylayout/ACCDET.kl:mtk
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k71v1_64_bsp/factory/res/images/lcd_test_00.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_00.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k71v1_64_bsp/factory/res/images/lcd_test_01.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_01.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k71v1_64_bsp/factory/res/images/lcd_test_02.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_02.png:mtk


# overlay has priorities. high <-> low.

# prize-huangzhanbin-20190319-add for dualcam-start
ifeq ($(strip $(ARCSOFT_DUALCAMERA)),yes)
PRODUCT_PACKAGES += dump_dual_camera
endif
