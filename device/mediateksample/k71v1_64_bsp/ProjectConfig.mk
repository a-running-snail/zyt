...
CUSTOM_HAL_IMGSENSOR = imx499_mipi_raw s5k2x5sp_mipi_raw s5k5e9yx_mipi_raw imx476_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = imx499_mipi_raw s5k2x5sp_mipi_raw s5k5e9yx_mipi_raw imx476_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx499_mipi_raw imx476_mipi_raw
...
CUSTOM_MODEM = k6306q-LWCTG_R3_6771-yxj-6M-V0.5
...
#prize modify by liuwei, close encryption,2018-09-07 begin
MTK_ENCRYPTION_DEFAULT_OFF = yes
#prize modify by liuwei, close encryption,2018-09-07 end
...
#prize  add  for main-3 by zhuzhengjiang    20190127-begin
MTK_CAM_MAX_NUMBER_OF_CAMERA = 4
#prize  add  for main-3 by zhuzhengjiang    20190127-end
...
#prize add by pengguangyi for fingerprint 20190122 start
PRIZE_FINGER_PRINT = gf5118m
#prize add by pengguangyi for fingerprint 20190122 end
MTK_CW2015_SUPPORT = yes
MICROTRUST_THH_SUPPORT = no
MICROTRUST_IFAA_SUPPORT = no
MICROTRUST_WECHAT_SUPPORT = no

PRIZE_SW_VERSION= K6306Q.KBEE.HDJ.P0.$(PRIZE_FLASH_CODE).$(shell date +%m%d_%H%M).V1.03_koobee_factory
...
PRIZE_BOARD_NETWORK_TYPE = GB/WB/CB/LtB/LfB
